...
inline bool ShowSimpleMessageBoxError(const std::string& title, const std::string& message)
{
    return ShowSimpleMessageBox(MESSAGEBOX_ERROR, title, message);
}

inline bool ShowSimpleMessageBoxWarning(const std::string& title, const std::string& message)
{
    return ShowSimpleMessageBox(MESSAGEBOX_WARNING, title, message);
}

inline bool ShowSimpleMessageBoxInformation(const std::string& title, const std::string& message)
{
